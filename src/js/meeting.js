...
$(function () {
    ...
    //mp.reg("Meeting Initiated", { "page": "meeting.html", "room": options['roomName'], "userDisplayName": localStorage.thisUserName });

    //end meeting button clicked
    document.getElementById("leave_meeting_button").addEventListener("click", function () {
        ga('send', {
            hitType: 'event',
            eventCategory: 'VidiCon - In Meeting Room',
            eventAction: 'Leave Meeting Button Clicked',
            eventLabel: 'Meeting Left By = ' + options['userInfo']['displayName']
        });
    });
    //alert('display name = ' + options['userInfo']['displayName'])
